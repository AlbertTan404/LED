...
class Tracking:
    ...
    def __init__(self, project_name, experiment_name, default_backend: Union[str, List[str]] = "console", config=None):
        ...
        if "tensorboard" in default_backend:
            default_local_dir = config.get("trainer", {}).get("default_local_dir", None) if config else None
            self.logger["tensorboard"] = _TensorboardAdapter(default_local_dir=default_local_dir)
...
class _TensorboardAdapter:
    def __init__(self, default_local_dir=None):
        ...
        # Priority: TENSORBOARD_DIR env var > default_local_dir/tensorboard > "tensorboard_log"
        if os.environ.get("TENSORBOARD_DIR"):
            tensorboard_dir = os.environ["TENSORBOARD_DIR"]
        elif default_local_dir:
            tensorboard_dir = os.path.join(default_local_dir, "tensorboard")
        else:
...
class ValidationGenerationsLogger:
    ...
    def log_generations_to_tensorboard(self, samples, step):
        ...
        if not hasattr(self, "writer"):
            ...
            if os.environ.get("TENSORBOARD_DIR"):
                tensorboard_dir = os.environ["TENSORBOARD_DIR"]
            elif self.default_local_dir:
                tensorboard_dir = os.path.join(self.default_local_dir, "tensorboard")
            else:
                tensorboard_dir = "tensorboard_log"
            os.makedirs(tensorboard_dir, exist_ok=True)
