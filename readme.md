...
pip install uv
uv pip install torch transformers accelerate jsonlines math_verify openai torch_memory_saver
MAX_JOBS=32 uv pip install flash_attn --no-build-isolation
...
## 🚀 Run LED for RL
```
bash scripts/run_verl.sh exp_name led
# with trainer.experiment_name=exp_name and actor_rollout_ref.rollout.led.method=led
```
![verl_train](assets/verl_train.png)
![verl_val](assets/verl_val.png)
